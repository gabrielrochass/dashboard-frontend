...
import "./graphics.css";
import PerCompany from "./perCompany";
...
const GeneralDashboard = ({ stats }) => {
    ...
    return (
        <div className="dashboard">
            ...
            <h1>
                {selectedPartner
                    ? `Partner Dashboard: ${selectedPartner}`
                    : "General Dashboard"}
            </h1>


                <div className="dashboard-selects"></div>
                <div className="dashboard-selects">
                    <div className="select-container">
                        <PerPartner selectedPartner={selectedPartner} setSelectedPartner={setSelectedPartner} />
                        <PerCompany />
                    </div>
                </div>  
            </div>
            ...
            {selectedPartner ? (
                <PerPartner selectedPartner={selectedPartner} />
            ) : (
